...
export default function Calk({ documents }) {
    ...
    const handleDeleteDocument = (id) => {
        if (confirm('Apakah Anda yakin ingin menghapus dokumen CALK ini?')) {
        ...
        <AuthenticatedLayout
            header={
                <h2 className="text-xl font-semibold leading-tight text-white">
                    Dokumen Catatan Atas Laporan Keuangan (CALK)
                </h2>
            }
        >
            <Head title="CALK" />
                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8">
                        <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500">
                            Manajemen Dokumen CALK
                        </h1>
                        <p className="text-slate-400 mt-2">Unggah dan kelola dokumen Catatan Atas Laporan Keuangan (CALK) Perangkat Daerah.</p>
                    </div>
                    ...
                    <div className="bg-slate-800/60 p-6 rounded-2xl border border-slate-700/50 backdrop-blur-md mb-8">
                        <div className="mb-6 bg-indigo-500/20 border border-indigo-500/30 p-4 rounded-lg flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-300 mt-1">
                                    Silakan unggah dokumen Catatan Atas Laporan Keuangan (CALK) format PDF. Maksimal ukuran file 10MB.
                                </p>
                            </div>
                        </div>
                        ...
                        <form onSubmit={submitForm} className="space-y-5 max-w-2xl">
                            <div>
                                <label className="block text-sm font-medium text-slate-300 mb-1">Tahun Periode</label>
                                <input 
                                    type="number" 
                    ...
                    <div className="bg-slate-800/60 p-6 rounded-2xl border border-slate-700/50 backdrop-blur-md mb-8">
                        ...
                        {documents && documents.length > 0 ? (
                            ...
                            <p className="text-slate-500 text-sm italic">Belum ada dokumen yang diunggah.</p>
                        )}
                    </div>
