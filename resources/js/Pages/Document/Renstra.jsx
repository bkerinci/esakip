...
export default function Renstra({ documents }) {
    ...
    const handleDeleteDocument = (id) => {
        if (confirm('Apakah Anda yakin ingin menghapus dokumen Renstra ini?')) {
            ...
            <div className="py-8 bg-slate-900 min-h-screen text-slate-100">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-slate-400 mt-2">Unggah dan kelola dokumen Rencana Strategis (Renstra) Perangkat Daerah.</p>
                    </div>
                    ...
                    <div className="bg-slate-800/60 p-6 rounded-2xl border border-slate-700/50 backdrop-blur-md mb-8">
                        <div className="mb-6 bg-indigo-500/20 border border-indigo-500/30 p-4 rounded-lg flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-300 mt-1">
                                    Silakan unggah dokumen Rencana Strategis (Renstra) format PDF. Maksimal ukuran file 10MB.
                                </p>
                            </div>
                        </div>
                        ...
                        <form onSubmit={submitForm} className="space-y-5 max-w-2xl">
                            <div>
                                <label className="block text-sm font-medium text-slate-300 mb-1">Tahun Periode (Awal)</label>
                                <input 
                                    type="number" 
                    ...
                    {/* Komponen Panduan Upload (Mungkin masih light theme) */}
                    <div className="mt-8">
                        <PanduanUpload />
                    </div>
                </div>
