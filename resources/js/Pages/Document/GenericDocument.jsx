...
export default function GenericDocument({ documents, title, uploadRoute, uploadType }) {
    ...
    const submitForm = (e) => {
        ...
        post(uploadType ? route(uploadRoute, uploadType) : route(uploadRoute), {
            preserveScroll: true,
            onSuccess: () => {
                reset('file');
            ...
            <div className="py-8 bg-slate-900 min-h-screen text-slate-100">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-slate-400 mt-2">Unggah dan kelola dokumen {title} Perangkat Daerah.</p>
                    </div>
                        ...
                        <div className="mb-6 bg-indigo-500/20 border border-indigo-500/30 p-4 rounded-lg flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-300 mt-1">
                                    Silakan unggah dokumen {title} format PDF. Maksimal ukuran file 10MB.
                                </p>
                            </div>
                        </div>
